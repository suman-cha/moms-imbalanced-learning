"""
Testing oversampling with 1 minority sample only.
"""
...
from sm_variants.datasets import load_1_min_some_maj
...
def test_1_min_some_maj(smote_class):
    """
...
def test_1_min_some_maj_additional(smote_obj):
    """
