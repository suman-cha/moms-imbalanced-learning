"""
Testing oversampling with 3 minority sample only.
"""
...
from sm_variants.datasets import load_3_min_some_maj
...
def test_3_min_some_maj(smote_class):
    """
...
def test_3_min_some_maj_additional(smote_obj):
    """
    Testing oversamplers with 3 minority samples.
