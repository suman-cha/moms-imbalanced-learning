"""
Testing oversampling with 4 minority sample only.
"""
...
from sm_variants.datasets import load_4_min_some_maj
...
def test_4_min_some_maj(smote_class):
    """
...
def test_4_min_some_maj_additional(smote_obj):
    """
    Testing oversamplers with 4 minority samples.
