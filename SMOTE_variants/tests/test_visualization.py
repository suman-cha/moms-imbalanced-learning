...
from sm_variants.visualization import (
    vector_labeling,
    plot_raw,
    plot_oversampled,
    plot_sampling_raw,
...
from sm_variants import SMOTE
from sm_variants.datasets import load_illustration_2_class, load_illustration_3_class
