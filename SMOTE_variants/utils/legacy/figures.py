...
def ballpark_sample(sampler_nf,
        ...
        Args:
            ...
            data_maj_user (np.array): user provided majority data
            data_min_user (np.array): user provided minority data
            center_min (np.array): centers of minority concepts with Gaussian distribution
            var_min (np.array): variances of minority concepts
            num_min (np.array): number of samples to generate from minority concepts
            center_maj (np.array): center of majority concept
            var_maj (np.array): variance of majority concept
