...
from sm_variants.base import coalesce, coalesce_dict
from sm_variants.base import NearestNeighborsWithMetricTensor
from sm_variants.base import OverSamplingSimplex
# from sm_variants._logger import logger
...
class MWMOTE(OverSamplingSimplex):
    ...
    def filter_minorities(self, X, y, nn_params, minority):
        ...
        nnmt = NearestNeighborsWithMetricTensor(
            n_neighbors=n_neighbors,  **(nn_params)
        )
        nnmt.fit(X)
