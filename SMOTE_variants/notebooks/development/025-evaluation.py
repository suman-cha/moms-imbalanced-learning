...
from sm_variants import get_simplex_sampling_oversamplers
from common_datasets.binary_classification import get_filtered_data_loaders

from sm_variants.evaluation import evaluate_oversamplers

import sm_variants
sm_variants.config.suppress_external_warnings(False)
...
oversamplers = get_simplex_sampling_oversamplers(within_simplex_sampling='random', 
                                                    n_dim_range=2, 
                                                    n_quickest=50)
oversamplers = [sm_variants.NEATER]
